    ...
    try {
        ...
        const measurementActivity = await prismaClient.measurementActivity.create({
            data: {
                ...
                description: dataMeasurement.description ? dataMeasurement.description : `Hasil pengukuran : ${dataMeasurement.bmi} kg` ,
            },
            select: {
                id: true,
                title: true,
        ...
        // Create History
        const historyMeasurement = await prismaClient.measurementHistoriesDigitProBMI.create({
            data: {
                patient_handler_id: patientHandler.id,
...
export const getByPatientIdService = async (query, page, limit, skip, patientId) => {
    try {
        ...
        const histroies = await prismaClient.measurementHistoriesDigitProBMI.findMany({
            where: whereCondition,
            skip: skip,
            take: limit,
            orderBy: {
...
export const getByDeviceIdService = async (query, page, limit, skip, deviceId) => {
    try {
        ...
        const histories = await prismaClient.measurementHistoriesDigitProBMI.findMany({
            where: whereCondition,
            skip: skip,
            take: limit,
            orderBy: {
