/*
  ...
  - You are about to drop the column `baby_id` on the `measurement_histories_digit_pro_ida` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `measurement_histories_digit_pro_ida` DROP FOREIGN KEY `measurement_histories_digit_pro_ida_baby_id_fkey`;

-- DropIndex
DROP INDEX `measurement_histories_digit_pro_ida_baby_id_fkey` ON `measurement_histories_digit_pro_ida`;

-- AlterTable
ALTER TABLE `babies` MODIFY `date_of_birth` DATETIME NOT NULL;

-- AlterTable
ALTER TABLE `measurement_histories_digit_pro_ida` DROP COLUMN `baby_id`;
