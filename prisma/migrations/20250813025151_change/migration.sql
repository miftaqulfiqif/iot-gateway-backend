...
*/
-- DropIndex
DROP INDEX `devices_connected_ip_address_key` ON `devices_connected`;

-- DropIndex
DROP INDEX `devices_connected_mac_address_key` ON `devices_connected`;

-- DropIndex
DROP INDEX `devices_connected_serial_number_key` ON `devices_connected`;
