/*
  ...
  - You are about to drop the column `serial_number` on the `devices_connected` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `devices_connected` DROP COLUMN `serial_number`,
