...
-- CreateTable
CREATE TABLE `measurement_histories_ptb_digi` (
...
-- AddForeignKey
ALTER TABLE `measurement_histories_ptb_digi` ADD CONSTRAINT `measurement_histories_ptb_digi_patient_handler_id_fkey` FOREIGN KEY (`patient_handler_id`) REFERENCES `patient_handlers`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
