/*
  ...
  - The values [HEIGHT,BLOOD_PRESSURE_SYSTOLIC,BLOOD_PRESSURE_DIASTOLIC,BLOOD_PRESSURE_MEAN,BODY_FAT_PERCENTAGE,MUSCLE_MASS,VISCERAL_FAT,BONE_MASS,BODY_WATER_PERCENTAGE,BASAL_METABOLIC_RATE,PROTEIN_PERCENTAGE,LEAN_BODY_MASS,BODY_AGE,OBESITY_LEVEL,OTHER] on the enum `device_parameters_parameter` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `device_parameters` MODIFY `parameter` ENUM('BODY_WEIGHT', 'BODY_HEIGHT', 'BMI', 'BODY_TEMPERATURE', 'BLOOD_PRESSURE', 'HEART_RATE', 'FETAL_HEART_RATE', 'PULSE_RATE', 'RESPIRATORY_RATE', 'SPO2', 'ECG', 'PLETHYSMOGRAM', 'PATIENT_MONITOR', 'VITAL_SIGN_MONITOR') NOT NULL;
