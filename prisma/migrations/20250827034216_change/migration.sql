/*
  ...
  - You are about to drop the column `weight_child` on the `measurement_histories_digit_pro_ida` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `measurement_histories_digit_pro_ida` DROP COLUMN `weight_child`,
    ADD COLUMN `weight_baby` FLOAT NULL;
