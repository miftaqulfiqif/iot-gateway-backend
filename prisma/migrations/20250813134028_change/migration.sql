/*
  ...
  - You are about to drop the column `token` on the `satu_sehat_env` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `satu_sehat_env` DROP COLUMN `token`,
