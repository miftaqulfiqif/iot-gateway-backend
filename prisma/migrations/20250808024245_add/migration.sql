/*
  ...
  - The values [serial] on the enum `devices_connected_connection` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `devices_connected` MODIFY `connection` ENUM('bluetooth', 'tcpip', 'usb_hid', 'usb_vcp', 'other') NOT NULL;
