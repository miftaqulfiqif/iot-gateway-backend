/*
  ...
  - You are about to drop the column `hospital_id` on the `devices_connected` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `devices_connected` DROP COLUMN `hospital_id`;
