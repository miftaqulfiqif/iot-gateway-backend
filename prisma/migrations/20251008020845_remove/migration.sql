/*
  ...
  - You are about to drop the column `measurement_type` on the `devices_connected` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `devices_connected` DROP COLUMN `measurement_type`;
