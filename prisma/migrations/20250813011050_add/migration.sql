...
-- AlterTable
ALTER TABLE `users` ADD COLUMN `gateway_id` VARCHAR(191) NULL,
    MODIFY `date_of_birth` DATETIME NULL;

-- AddForeignKey
ALTER TABLE `users` ADD CONSTRAINT `users_gateway_id_fkey` FOREIGN KEY (`gateway_id`) REFERENCES `iot_gateways`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
