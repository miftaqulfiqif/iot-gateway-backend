...
-- AlterTable
ALTER TABLE `devices_connected` ADD COLUMN `measurement_type` VARCHAR(255) NOT NULL DEFAULT 'OTHER';

-- AlterTable
ALTER TABLE `measurement_histories_digit_pro_bmi` ADD COLUMN `height` FLOAT NULL,
    MODIFY `age` FLOAT NULL,
    MODIFY `bmi` FLOAT NULL,
    MODIFY `body_fat` FLOAT NULL,
    MODIFY `muscle_mass` FLOAT NULL,
    MODIFY `water` FLOAT NULL,
    MODIFY `visceral_fat` FLOAT NULL,
    MODIFY `bone_mass` FLOAT NULL,
    MODIFY `metabolism` FLOAT NULL,
    MODIFY `protein` FLOAT NULL,
    MODIFY `obesity` FLOAT NULL,
    MODIFY `body_age` FLOAT NULL,
    MODIFY `lbm` FLOAT NULL;
