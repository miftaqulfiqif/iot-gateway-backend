...
*/
-- DropForeignKey
ALTER TABLE `device_parameters` DROP FOREIGN KEY `device_parameters_device_function_fkey`;

-- DropIndex
DROP INDEX `device_parameters_device_function_key` ON `device_parameters`;
